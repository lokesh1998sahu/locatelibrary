...
//
// Its jobs are:
//   1) Declare LMA's OWN manifest + theme so /lma960805 installs as an independent
...
//   2) Mount <PwaRegister> to register the LMA service worker (scoped to /lma960805).
...
export const metadata: Metadata = {
  ...
  manifest: "/lma960805/manifest.webmanifest",
  appleWebApp: {
    capable: true,
